...
export default function PostTable() {
    ...
    const columns = [
        ...
        { field: 'userEmail', headerName: 'User Email', width: 300, sortable: false },
        { field: 'content', headerName: 'Content', width: 300, sortable: false },
        { field: 'numOfComments', headerName: 'Number of comments', width: 160, sortable: false, valueGetter: (params) => `${params.row?.allCommentIDs?.length}` },
        {
